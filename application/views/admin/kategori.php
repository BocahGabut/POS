                                                ...
                                                <td><?php echo $u->nama_kategori ?></td>
                                                        <td>
                                                            <a data-placement="top" title="Edit" data-toggle="tooltip" class="mb-6 btn-floating waves-effect waves-light cyan">
                                                               <button type="button" data-target="#edit<?php echo $u->kode_kategori ?>" data-toggle="modal" class="btn btn-icon btn-success mr-1 mb-1"><i class="fa fa-edit"></i>
                                                    </button>
                                                    </a>
                                                    <a onclick="delete_message('<?php echo $u->kode_kategori ?>','<?php echo base_url(); ?>admin/kategori/delete')" class="mb-6 btn-floating waves-effect waves-light red accent-2">
...
<script type="text/javascript">
    function delete_message(id, url) {
        ...
        <?php
        $this->load->view('form/modal_kategori');
